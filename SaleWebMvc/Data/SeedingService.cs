...
namespace SaleWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed(SaleWebMvcContext _context)
        {
            ...
            Seller s5 = new Seller("Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, 3, d3);
            Seller s6 = new Seller("Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0, 2, d2);
